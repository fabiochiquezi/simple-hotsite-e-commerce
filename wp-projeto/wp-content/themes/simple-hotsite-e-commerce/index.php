        ...
        <div class="row">
            ...
            <div class="contact-1 d-lg-flex">
              ...
              <ul class="social d-flex">
                <li><a href="https://www.facebook.com/" target="_blank"><i class="icon icon-face"></i></a></li>
                <li><a href="https://www.instagram.com/?hl=pt-br" target="_blank"><i class="icon icon-insta"></i></a></li>
                <li><a href="https://api.whatsapp.com/send?phone=5511983127035" target="_blank"><i class="icon icon-whats"></i></a></li>
              </div>
            </div>
